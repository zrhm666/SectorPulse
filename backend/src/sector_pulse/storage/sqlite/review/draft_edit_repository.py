...
class SQLiteDraftEditRepository:
    ...
    def apply_patch(
        ...
        *,
        ...
        with self._database.transaction() as connection:
            ...
            return self.apply_patch_in_transaction(
                connection, draft_id, base_version, operations, actor=actor
            )
    ...
    def apply_patch_in_transaction(
        ...
        *,
        ...
        """Apply a human edit on a caller-owned connection.

        The caller owns the transaction so a human edit can be committed
        atomically with the orchestration snapshot revision it was based on.
        """
