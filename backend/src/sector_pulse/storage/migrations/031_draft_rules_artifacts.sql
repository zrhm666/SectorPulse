CREATE TABLE IF NOT EXISTS draft_rules_artifacts (
...
CREATE INDEX IF NOT EXISTS idx_draft_rules_version
    ON draft_rules_artifacts(run_id, draft_id, draft_version);
