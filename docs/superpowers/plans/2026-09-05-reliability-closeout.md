...
- [x] 2026-09-06 升级 Vite 8.2.2 / React 插件 6.1.1，修复开发模式生命周期缺陷；343 后端、185 前端、4 工具链及生产/开发各 40 浏览器测试通过，全量与生产 npm 审计均为 0 个已知漏洞。见 [工具链验收](../acceptance/2026-09-06-web-toolchain-security.md)，保留此前审计的历史结果。
